...
python eliozo_client.py add-metadata ../../math/problembase/LV.AMO/lv-amo-2024/content_lv.md hasSolutionConcept --mode text --provider gpt-4o --output ../../math/problembase/LV.AMO/lv-amo-2024/content_lv2.md --reference ../../math/problembase/LV.VOL/lv-vol-2019/problemdata.json
